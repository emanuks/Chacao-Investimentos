...
|2|Realizar logout|Teste da funcionalidade de deslogar o usuário da plataforma|1. Realize a autenticação na plataforma<br>2. Selecione a opção sair no canto superior direito|Usuário desconectado da plataforma com sucesso|Conforme o esperado|
